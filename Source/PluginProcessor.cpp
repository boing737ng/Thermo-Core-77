...
//==============================================================================
const juce::String ThermoCore77AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool ThermoCore77AudioProcessor::acceptsMidi() const
{
...
bool ThermoCore77AudioProcessor::producesMidi() const
{
...
bool ThermoCore77AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double ThermoCore77AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int ThermoCore77AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int ThermoCore77AudioProcessor::getCurrentProgram()
{
    return 0;
}

void ThermoCore77AudioProcessor::setCurrentProgram (int index)
{
}

const juce::String ThermoCore77AudioProcessor::getProgramName (int index)
{
    return {};
}

void ThermoCore77AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
